...
You can either copy the data from this [GitHub link](https://raw.githubusercontent.com/ml4sts/data-empowerment-lessons/main/episodes/data/anonymized_data.csv)
and paste it into a file called `anonymized_data.csv` in the `data/` directory or
copy-paste the below code chunk into your terminal:
```{r anonymized_data, eval=FALSE}
download.file(
  "https://raw.githubusercontent.com/ml4sts/data-empowerment-lessons/main/episodes/data/anonymized_data.csv",
  "data/anonymized_data.csv", mode = "wb"
  )
```

#### Anonymized Data Sample:

You can either copy the data from this [GitHub link](https://raw.githubusercontent.com/ml4sts/data-empowerment-lessons/main/episodes/data/anonymized_data_2_sample.csv)
and paste it into a file called `anonymized_data_2_sample.csv` in the `data/` directory or
copy-paste the below code chunk into your terminal:
```{r anonymized_data, eval=FALSE}
download.file(
  "https://raw.githubusercontent.com/ml4sts/data-empowerment-lessons/main/episodes/data/anonymized_data_2_sample.csv",
  "data/anonymized_data_2_sample.csv", mode = "wb"
  )
```
...
You can either copy the data from this [GitHub link](https://raw.githubusercontent.com/ml4sts/data-empowerment-lessons/main/episodes/data/voting_example_GoT.csv)
and paste it into a file called `voting_example_GoT.csv` in the `data/` directory or
copy-paste the below code chunk into your terminal:
```{r anonymized_data, eval=FALSE}
download.file(
  "https://raw.githubusercontent.com/ml4sts/data-empowerment-lessons/main/episodes/data/voting_example_GoT.csv",
  "data/voting_example_GoT.csv", mode = "wb"
  )
```

You can either copy the data from this [GitHub link](https://raw.githubusercontent.com/ml4sts/data-empowerment-lessons/main/episodes/data/polygons_example_GoT.geojson)
and paste it into a file called `polygons_example_GoT.geojson` in the `data/` directory or
copy-paste the below code chunk into your terminal:
```{r anonymized_data, eval=FALSE}
download.file(
  "https://raw.githubusercontent.com/ml4sts/data-empowerment-lessons/main/episodes/data/polygons_example_GoT.geojson",
  "polygons_example_GoT.geojson", mode = "wb"
  )
```
