...
- Go very slowly in the "Getting set up" section. Make sure everyone is following
  ...
  a `data` (all lowercase) sub-folder.
...
or your browser. There are many options for customizing your presentation slides, 
including an option for showing La-TeX equations. This can help you collaborate
...
provides many shortcuts, auto completion, and highlighting for the major file
...
- **`data/`** Use this folder to store your raw data and intermediate data sets.
  ...
  your data cleanup and pre-processing programmatically (i.e., with scripts,
  rather than manually) as possible.
- **`data_output/`** When you need to modify your raw data,
  it might be useful to store the modified versions of the data sets in a
  different folder.
...
**`data/`** and **`fig_output/`**. Let's write them all in
...
You can either copy the data from this [GitHub link](https://raw.githubusercontent.com/ml4sts/data-empowerment-lessons/main/episodes/data/checkin_data.csv)
and paste it into a file called `checkin_data.csv` in the `data/` directory or
copy-paste the below code chunk into your terminal:
```{r anonymized_data, eval=FALSE}
download.file(
  "https://raw.githubusercontent.com/ml4sts/data-empowerment-lessons/main/episodes/data/checkin_data.csv",
...
You can either copy the data from this [GitHub link](https://raw.githubusercontent.com/ml4sts/data-empowerment-lessons/main/episodes/data/checkin_sample_plotting.csv)
and paste it into a file called `checkin_sample_plotting.csv` in the `data/` directory or
copy-paste the below code chunk into your terminal:
```{r anonymized_data_plotting, eval=FALSE}
download.file(
  "https://raw.githubusercontent.com/ml4sts/data-empowerment-lessons/main/episodes/data/checkin_sample_plotting.csv",
...
You can either copy the data from this [GitHub link](https://raw.githubusercontent.com/ml4sts/data-empowerment-lessons/main/episodes/data/messy_data.csv)
and paste it into a file called `messy_data.csv` in the `data/` directory or
copy-paste the below code chunk into your terminal:
```{r anonymized_data_messy, eval=FALSE}
download.file(
  "https://raw.githubusercontent.com/ml4sts/data-empowerment-lessons/main/episodes/data/messy_data.csv",
  "messy_data.csv", mode = "wb"
  )
```

#### Game of Thrones Dataset:

You can either copy the data from this [GitHub link](https://raw.githubusercontent.com/ml4sts/data-empowerment-lessons/main/episodes/data/voting_GoT.csv)
and paste it into a file called `voting_GoT.csv` in the `data/` directory or
copy-paste the below code chunk into your terminal:
```{r anonymized_data_gotvoting, eval=FALSE}
download.file(
  "https://raw.githubusercontent.com/ml4sts/data-empowerment-lessons/main/episodes/data/voting_GoT.csv",
  "data/voting_GoT.csv", mode = "wb"
  )
```

You can either copy the data from this [GitHub link](https://raw.githubusercontent.com/ml4sts/data-empowerment-lessons/main/episodes/data/polygons_GoT.geojson)
and paste it into a file called `polygons_GoT.geojson` in the `data/` directory or
copy-paste the below code chunk into your terminal:
```{r anonymized_data_gotpolygons, eval=FALSE}
download.file(
  "https://raw.githubusercontent.com/ml4sts/data-empowerment-lessons/main/episodes/data/polygons_GoT.geojson",
  "polygons_GoT.geojson", mode = "wb"
  )
```

#### JSON Check-In Dataset:

You can either copy the data from this [GitHub link](https://raw.githubusercontent.com/ml4sts/data-empowerment-lessons/main/episodes/data/checkin_snippet.json)
and paste it into a file called `checkin_snippet.json` in the `data/` directory or
copy-paste the below code chunk into your terminal:
```{r anonymized_data_json, eval=FALSE}
download.file(
  "https://raw.githubusercontent.com/ml4sts/data-empowerment-lessons/main/episodes/data/checkin_snippet.json",
...
We will be using additional packages to manage paths, plots, json files, and shape 
files. We will discuss these in more detail in a later episode, but we will install 
them now in the console:
