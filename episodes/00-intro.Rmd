...
We will be using additional packages to manage paths, plots, and shape files. 
We will discuss these in more detail in a later episode, but we will install them 
now in the console:

```{r, eval=FALSE}
install.packages("here", "lattice", "sf")
```
