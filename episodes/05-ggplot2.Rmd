...
data <- read_csv(here("data", "anonymized_data_2_sample.csv"))
```
...
westeros_map <- st_read(here("data", "polygons_example_GoT.geojson"), quiet = TRUE)
...
#read in data and save to object
got_votes <- read_csv(here("data", "voting_example_GoT.csv"))
